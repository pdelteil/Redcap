...
//if (true) { 
	...
	//echo "<pre> Funcion de permisos<br>";
	//echo  print_r($rights,true) . "</pre>";
	//full export = 1; de identified = 2
	if ($rights['data_export_tool'] != 1 &&  $rights['data_export_tool'] !=2) {
...
foreach ($batches as $b => $batch) {
	print "<pre>Batch $b starts with id " . $batch[0] . "</pre>";
